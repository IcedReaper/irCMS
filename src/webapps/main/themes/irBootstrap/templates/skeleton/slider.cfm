<cfoutput>
    ...
    <article id="#attributes.id#" class="module carousel slide" data-ride="carousel" <cfif attributes.keyExists('interval')>data-interval="#attributes.interval#"</cfif> <cfif attributes.keyExists('pause')>data-pause="#attributes.pause#"</cfif> <cfif attributes.keyExists('wrap')>data-wrap="#attributes.wrap#"</cfif>>
        <ol class="carousel-indicators">
            <cfloop from="1" to="#attributes.images.len()#" index="position">
                <li data-target="###attributes.id#" data-slide-to="#position-1#" <cfif position EQ 1>class="active"</cfif>></li>
            </cfloop>
        </ol>
