    ...
    public struct function addContentVersion(required numeric navigationId, required numeric userId, required struct versionData) {
    	...
    	if(this.allSuccessfull(formValidation)) {
            new Query().setDatasource(variables.datasource)
                       ...
                       .addParam(name="entityRegExp",         value=arguments.versionData.entityRegExp,         cfsqltype="cf_sql_varchar", null="#arguments.versionData.entityRegExp         == '' ? true : false#")
                       ...
                       .addParam(name="canonical",            value=arguments.versionData.canonical,            cfsqltype="cf_sql_varchar", null="#arguments.versionData.canonical            == '' ? true : false#")
